<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Resource_FeaturedImage.ascx.cs" Inherits="DNNGo.Modules.DNNGalleryV7.Resource_FeaturedImage" %>
    <div class="row">
        <div class="col-sm-8">
      ...
      <!-- end--> 
            ...
            <script type="text/javascript">
                ...
                function ReturnThumbnail(PictureUrl, PictureID) {
                    ...
                    window.parent.$('#AddThumbnail_Modal').modal('hide');
                }
