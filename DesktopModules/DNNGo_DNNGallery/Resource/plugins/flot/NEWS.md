...
Addly, if a strftime function is found in the Date object's prototype,
...
### Changes ###
 ...
 - Added support for high pixel density (retina) displays, resulting in much
   crisper charts on such devices. (patch by Olivier Guerriat, Add
 ...
 - Added the ability to set width and color for individual sides of the grid.
   (patch by Ara Anjargolian, Add fixes by Karl Swedberg, pull requests #855
   and #880)
